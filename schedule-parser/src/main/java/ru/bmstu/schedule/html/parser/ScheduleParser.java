...
public class ScheduleParser {
    ...
    public List<ScheduleDayNode> scheduleFor(GroupNode group) throws IllegalStateException, IOException {
    ...
    public List<ScheduleDayNode> scheduleFor(String groupId) throws IOException, IllegalArgumentException {
