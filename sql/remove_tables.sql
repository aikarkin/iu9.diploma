DROP TRIGGER IF EXISTS tirgger_upd_classtime ON class_time;
...
DROP TABLE IF EXISTS department_to_specialization CASCADE;
...
DROP TABLE IF EXISTS lecturer_subject CASCADE;
